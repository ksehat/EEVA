...
class xabc_trader():
    ...
    def MACD_IND(self,data,win_slow,win_fast,win_sign):
    ...
    def Ichi(self,data,win1,win2,win3):
    ...
    def plot_figure(self,df,index_X,index_A,index_B,index_C,index_buy,index_sell,X,A,B,C,width,height):
    ...
    def macd_phase_change(self,df,date_pointer):
        if df['MACD_Hist'][date_pointer]*df['MACD_Hist'][date_pointer-1]<0: return True
        else: return False

    def print_trade(self,df,X,A,B,xab,enter_price,exit_price,index_X,index_A,index_B,index_buy,
                    index_sell):
    ...
    def minutes_of_new_data(self,symbol, kline_size, data, start_date, source):
        if len(data) > 0:
    ...
    def get_all_binance(self,symbol, kline_size, start_date='1 Jan 2021', save=False):
    ...
    def xab_enter_check(self,df,date_pointer,xab,enter):
    ...
    def xab_completor(self,df,date_pointer,xab, XAB_del_list):
    ...
    def xab_reject_decision(self,df,dp,xab,XAB_del_list,XAB_check_list):
        if xab[2]==1:
