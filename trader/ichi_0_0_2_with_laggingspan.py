...
def exit_check(df, dp, ls, enter, enter_price, exit_price, target_flag, target_percent,
               tp1_percent):
...
# leverage = 1
# input_list = [
#     [20, 21, 20, 40, 0.01, 0.08, symbol, start_date, data_step, end_date, 1]
# ]
