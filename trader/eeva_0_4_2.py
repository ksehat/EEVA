...
def print_trade(df, xab, enter2, enter_price, enter_price2, exit_price,
        ...
        if enter:
            ...
            if df['MACD1_Hist'][date_pointer] < 0:
                ...
                while df['MACD1_Hist'][date_pointer - i] < 0:
                    if df['low'][date_pointer - i] < xab[4] and df['low'][date_pointer - i] >= \
                            xab[0][3]:
...
def xab_enter_check_pullback(df, date_pointer, xab, enter2, enter_price2, wait_candles):
    if xab[2]:
        if xab[6] >= 1:
            xab[6] += 1
            ...
            if enter == 1:  # If it is in trade
                ...
                if xab[2] == 1:
                    ...
                    if df['low'][date_pointer] < xab[3]:
                        ...
                        sl_at_this_candle = 0
                        if print_outputs:
                            print_trade(df, xab, enter2, enter_price, enter_price2, exit_price,
                                        index_buy, index_buy2, index_sell)
                        ...
                        if money > temp_money:
                            profit_loss_list.append(pl1 + pl2)
                            num_of_pos_trades += 1
                            if print_outputs:
                                print('profit:', pl1 + pl2)
                                print('money:', money)
                        else:
                            profit_loss_list.append(pl1 + pl2)
                            num_of_neg_trades += 1
