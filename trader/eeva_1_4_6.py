...
def print_trade(df, df2, xab, enter_price, exit_price, index_buy, index_sell, exit_mode):
...
def extra_calculations(df, df2, xab, money, enter_price,
                       ...
                       print_outputs, trade_fee, profit_loss_list, exit_mode):
    if xab[2]:
        if print_outputs:
            print_trade(df, df2, xab, enter_price, exit_price, index_buy, index_sell, exit_mode)
                ...
                for date_pointer2 in [date_pointer22, date_pointer22 + 1]:
                    ...
                    if xab[2] == 1:
                        if df2['low'][date_pointer2] < xab[0][3]:
                            ...
                            break_flag = 1
                            break
                        if df2['high'][date_pointer2] >= xab[0][2] + abs(xab[0][2]-xab[0][3]):
                            enter = 0
                            index_sell = date_pointer2
                    ...
                    if xab[2] == 0:
                        if df2['high'][date_pointer2] > xab[0][3]:
                            ...
                            break_flag = 1
                            break
                        if df2['low'][date_pointer2] <= xab[0][2] - abs(xab[0][2]-xab[0][3]):
                            enter = 0
                            index_sell = date_pointer2
                            exit_price = xab[0][2] - abs(xab[0][2]-xab[0][3])
                            date_of_trade_list.append(df2['timestamp'][date_pointer2])
                            ...
                            break_flag = 1
                            break
    print(max_num_of_loss_trades(profit_loss_list))
    print(money)
